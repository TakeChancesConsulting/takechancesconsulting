  ...
  return (
    <div className="fixed top-6 left-0 right-0 z-50 flex justify-center px-4">
      <motion.nav
        ...
        className="navbar bg-white/80 backdrop-blur-md rounded-full shadow-lg shadow-gray-200/50 px-6 lg:px-10 max-w-7xl w-full border border-gray-200"
      >
        <div className="navbar-start">
          <a href="#" className="text-xl lg:text-2xl font-playfair font-bold text-teal-600 whitespace-nowrap">
            Take Chances
          </a>
        </div>
        ...
        <div className="navbar-end">
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="btn btn-md font-inter text-base rounded-full bg-teal-600 hover:bg-teal-700 border-none text-white font-semibold"
          >
            Contact Me
          </motion.a>
        </div>
